                ...
                <AccordionTab header="Mi Ubicación">
                    <TecnicoUbicacion
                        visitas={visitas.map((v) => ({
                            id: v.id, // CORRECCIÓN: Cambiar v.id por v.id_visita
...
//                     <TecnicoUbicacion
//                         visitas={visitas.map((v) => ({
//                             id: v.id, // Cambié v.id por v.id_visita (basado en tus columnas)
//                             latitud: Number(v.latitud),
//                             longitud: Number(v.longitud),
//                             estado_visita: v.estado_visita,
//                             nombre_cliente: v.nombre_cliente // ¡Agrega esta línea!
//                         }))}
//                         refreshKey={mapRefresh}
//                     />
//                 </AccordionTab>
